...
//+kubebuilder:rbac:groups=driver.ndd.henderiw.be,resources=networknodes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=driver.ndd.henderiw.be,resources=networknodes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=driver.ndd.henderiw.be,resources=networknodes/finalizers,verbs=update
